...
const shareService = {
  ...
  // Helper for sharing app builds via URL
  async shareAppBuild(buildUrl, title = 'Try my app!') {
    return this.share({
      title: title,
      text: 'Check out this app I built',
      url: buildUrl,
      dialogTitle: 'Share app build'
    });
  }
};
...
// Export all services
export {
  cameraService, deviceService, getPlatform, hapticService, isNative, locationService, motionService, shareService, storageService
};
